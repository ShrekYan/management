...
class Http implements IHttp {
    ...
    compatibleOldInterface<KParams>(
        ...
        const isOptions = (obj: any): obj is IOptions =>
        ...
        const errorExitAndCloseLoading = isOptions(safeParams) ? safeParams.errorExitAndCloseLoading : undefined;
        ...
        const compatibleOptions: IOptions = {
            ...
            errorExitAndCloseLoading: errorExitAndCloseLoading ?? mergedOptions.errorExitAndCloseLoading,
    ...
    callMockData<KParams, TResponse>(
        ...
        // 生成YAPI服务器接口链接
        const tempRequestUrl = this.getRequestUrl(true, this.mockUrlPrefix + requestUrl,
            this.mergeDefaultOptions(options) as IOptions);

        return httpFlow<KParams, IResponseData<TResponse>>(requestUrl, params,
    ...
    post<KParams, TResponse>(
        ...
        // request url
        const tempRequestUrl = this.getRequestUrl(mergedOptions.customUrl, requestUrl, mergedOptions);
        ...
        if (mergedOptions.backupMockData) {
            return httpFlow<KParams, IResponseData<TResponse>>(requestUrl, safeParams, mergedOptions, () => {
